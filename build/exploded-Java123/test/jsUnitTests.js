...
var _bootboxWrapper = __webpack_require__(3);
...
function bindDeleteButtons() {
    $('body').on('click', '.session-delete-for-test', function (event) {
        ...
        (0, _bootboxWrapper.showModalConfirmation)('Confirm deleting feedback session', messageText, okCallback, null, null, null, _const.BootstrapContextualColors.DANGER);
    });
}
...
var _instructor = __webpack_require__(2);
...
function toggleAssignWeightsRow($checkbox) {
    var $weightsRow = $checkbox.closest('form').find('tr[id^="rubricWeights"]');
...
var _instructorCourseEnrollHelper = __webpack_require__(36);
...
QUnit.test('getUpdatedHeaderString(handsontableColHeader)', function (assert) {
    ...
    assert.equal((0, _instructorCourseEnrollHelper.getUpdatedHeaderString)(colHeaders), expectedHeaderString, 'Correct header string generated');
});
...
QUnit.test('getUserDataRows(spreadsheetData)', function (assert) {
    ...
    assert.equal((0, _instructorCourseEnrollHelper.getUserDataRows)(spreadsheetData), expectedUserDataRows, 'Correct user data string generated');
});

QUnit.test('getUpdatedData(spreadsheetDataRows, data)', function (assert) {
    assert.expect(1);
    ...
    var data = (0, _instructorCourseEnrollHelper.getUpdatedData)(spreadsheetDataRows);
