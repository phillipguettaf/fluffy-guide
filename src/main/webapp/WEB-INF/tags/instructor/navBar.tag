    ...
    <div class="collapse navbar-collapse" id="contentLinks">
      <ul class="nav navbar-nav">
        ...
        <li <c:if test="${fn:contains(data.getClass(), 'Forum')}">class="active"</c:if>>
          <a href="<%=Const.ActionURIs.FORUM%>">Forum</a>
        </li>
        ...
        <li<c:if test="${fn:contains(data.getClass(), 'Forums')}"> class="active"</c:if>>
          <a class='nav forum' data-link="instructorForum" href="${data.instructorForum}">Forum</a>
        </li>
